    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-9 d-flex align-items-center">
           <a href="index.html" class="logo mr-auto"><img src="assets/img/dt-logo.png" alt="" class="img-fluid"></a>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>About Us</h3>
            <p class="font-italic">
              A tribe is often defined as a group of people linked by a common thread and having a common culture.
            </p>
            <!-- <ul>
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Our Services</h2>
          <p>We are a start-up with years of experience when it comes to providing various IT enabled services. We work with our clients to meet their all IT related needs. We have expertise in designing websites as per your requirements and specifications.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <p>We design and develop website which are both informational and e-commerce.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-orange ">
              ...
              <p>We develop mobile apps for both IOS and Android.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-pink">
              ...
              <p>We provide SEO, SEM and SMM services.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-yellow">
              ...
              <p>We develop customized app for Moodle Learning Management System.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              ...
              <p>We provide wordpress theme developmenet services.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal">
              ...
              <p>We provide server management services.</p>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-card">Development</li>
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4>Design, HTML5, Parallax JS</h4>
                <p>Aswini</p>
              </div>
              <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4>Iphone App, Android APP, SDK, APSN, Fnetwork</h4>
                <p>Whatsnext</p>
              </div>
              <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4>Design, HTML5, Wordpress</h4>
                <p>OM Triple R India Private Limited Website</p>
              </div>
              <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/p5.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>IOS & Android App</h4>
                <p>Eatz App</p>
              </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/p6.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Design, HTML5, Animations</h4>
                <p>Mouttetcapital Website</p>
              </div>
              <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/p7.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>IOS & Android App</h4>
                <p>Serve to Seat App</p>
              </div>
              <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-card">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4>Design, HTML5, Parallax JS, Wordpress</h4>
                <p>Sree Sannidi Associates Website</p>
              </div>
              <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/p9.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Design, Responsive, Magento</h4>
                <p>Macrovet.nl Website</p>
              </div>
              <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <h4>Design, Responsive, PHP5.5</h4>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/p11.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>HTML5, Videos with Animations</h4>
                <p>Inetdesign Website</p>
              </div>
              <div class="portfolio-links">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/portfolio/p12.png" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4>Design, Responsive, Prestashop</h4>
                <p>Martial Kelojou E-commerce Website</p>
              </div>
              <div class="portfolio-links">
